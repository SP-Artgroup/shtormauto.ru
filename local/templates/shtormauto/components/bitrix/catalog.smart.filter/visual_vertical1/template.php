...
$i = 1;
?>
		<form name="<?echo $arResult['FILTER_NAME'].'_form'?>" action="/catalog<?=$arResult['FORM_ACTION']?>" method="get" class="filter-item__form">
				...
				if(isset($arItem["PRICE"])):
					...
					<div class="bx_filter_parameters_box active">
						...
						<div class="bx_filter_block">
							<div class="form-slider" data-start-min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" data-start-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" data-range-min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" data-range-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>">
							<div class="form-slider__inputs">		
                                                            <div class="form-slider__input-wrapper">
										<input
											class="form-input form-slider__input"
											type="text"
									...
									<div class="form-slider__input-wrapper">
										...
										/>
                                                                ...
                                                                <div class="form-slider__control" data-range-slider></div>
							</div>
						</div>
					</div>
					<?
				...
				?>
						...
						switch ($arItem["DISPLAY_TYPE"])
						{
							...
							case "P"://DROPDOWN
								...
								?>
								<div class="bx_filter_select_container filter-item__sizes-item">
