	...
	<div data-role="basket-item-list" class="basket-preview__list">
					...
					<div class="basket-item">
                                            ...
                                            <div class="basket-item__info">
                                              <div class="basket-item__info-top">
                                                ...
                                                <a href="javascript:void(0)" class="basket-item__delete" onclick="<?=$cartId?>.removeItemFromCart(<?=$v['ID']?>)"><i class="icon i-delete"></i></a>
                                              </div>
		...
		<?if ($arParams["PATH_TO_ORDER"] && $arResult["CATEGORIES"]["READY"]):?>
                        <div class="basket-preview__buttons">
                          ...
                          <a href="<?=$arParams["PATH_TO_ORDER"]?>" class="btn btn-dark"><?=GetMessage("TSB1_2ORDER")?></a>                          
                        </div>                
		<?endif?>
    </div>
	<script>
