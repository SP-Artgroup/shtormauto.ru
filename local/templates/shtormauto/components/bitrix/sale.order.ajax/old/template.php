...
$this->addExternalCss($templateFolder . '/css/confirm.css');
$this->addExternalCss($templateFolder . '/_template_styles.css');

$this->addExternalJs('//api-maps.yandex.ru/2.1/?lang=ru_RU');

$isLocationProEnabled = $arResult['LOC_PRO_ENABLED'];

$jsData = [
    'loc_pro_enabled' => $isLocationProEnabled,
];
...
<div class="bx_order_make cart_page">
    <?
    ...
    else
    {
        ...
        else
        {
            ...
            <script type="text/javascript">
                ...
                OrderMap.init(<?= json_encode($jsData) ?>);
                ...
                var isLocProEnabled = <?= json_decode($isLocationProEnabled) ?>;
                ...
                ?>
                    ...
                    <div class="bx_ordercart_order_pay_center">
                        ...
                        <div class="itogo_button">
                            <input class="button" type="button" value="Завершить оформление" onclick="submitForm('Y'); return false;" id="ORDER_CONFIRM_BUTTON">
                        </div>
                    </div>
                </form>
                <?
