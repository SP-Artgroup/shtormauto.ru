...
$resSection = CIBlockSection::GetNavChain(false, $arResult['ID']);
$arSetionsId = [];
...
$rsSect = CIBlockSection::GetList(array('id' => 'asc'), $arFilter, false, array("ID", "UF_EX_GUARANT", "UF_FREE_REPAIR", "UF_SHOW_PRICE"));
