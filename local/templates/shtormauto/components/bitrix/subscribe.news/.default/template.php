...
?>
	<tr><td>
		<font class="text">
			<?if($arItem["PREVIEW_PICTURE"]):?>
				<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" style="float:left; display:inline-block; margin-right:10px; width:150px; height:auto;">
					<img align='left' src="<?echo $sImagePath?>" alt="<?echo $arItem["PREVIEW_PICTURE"]["ALT"]?>"  title="<?echo $arItem["NAME"]?>">
				</a>
			<?endif;?>
			<span>
