...
<div class="content-form-body content-form-body--user-profile">
    <div class="content-form content-form--margin-bottom-69 form-container">
        <div class="show-errors"><?dump($arResult);?></div>
        <?
        if ($arResult['DATA_SAVED'] == 'Y'){?>
            <div style="text-align: center;"><?ShowNote(GetMessage('PROFILE_DATA_SAVED'));?></div>
           <?}?> 
...
var cookie_prefix = '<?=$arResult["COOKIE_PREFIX"]?>';
    ...
    <div class="d-flex justify-content-center">
        <input class="btn btn-dark content-form-body__button" type="submit" name="save" value="Сохранить изменения">
    </div>
 </form>
</div>
<script>
