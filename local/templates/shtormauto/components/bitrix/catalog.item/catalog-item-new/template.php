...
$sezon = "";
$hit = "";
if ($item["PROPERTIES"]["SEZONNOST"]["VALUE_ENUM_ID"]=="32478"){
    $sezon = "product-marks--winter";
}
if ($item["PROPERTIES"]["SEZONNOST"]["VALUE_ENUM_ID"]=="32479"){
    $sezon = "product-marks--summer";
}
if ($item["PROPERTIES"]["NEWITEM"]["VALUE_ENUM_ID"]=="33004"){
    $hit = "product-marks--new";
}
if ($item["PROPERTIES"]["HITITEM"]["VALUE_ENUM_ID"]=="61146"){
    $hit = "product-marks--hit";
}
?>
        <div class="product-item <?= (isset($arResult['SCALABLE']) && $arResult['SCALABLE'] === 'Y' ? ' product-item-scalable-card' : '') ?>"
