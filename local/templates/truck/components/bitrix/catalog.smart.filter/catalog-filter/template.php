...
<div class="filter-container">
	...
	<h2>
		<?= GetMessage("CT_BCSF_FILTER_TITLE")?> <i class="fas fa-filter"></i>
	</h2>
	...
	<form name="<?= $arResult["FILTER_NAME"]."_form"?>" action="<?= $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
		...
		foreach($arResult["ITEMS"] as $key=>$arItem)
		{
			...
			<div class="filter-item bx-filter-parameters-box">
				...
				<p class="name">
					<?= $arItem["NAME"] ?> <i class="fas fa-caret-down"></i>
				</p>
				...
				*/ ?>
				...
				<div class="filter-check <?if($arItem['DISPLAY_EXPANDED']=='Y'):?>active<? endif;?>" data-role="bx_filter_block">
							...
							<div class="checkbox">
								<?php foreach ($arItem["VALUES"] as $val => $ar): ?>
									<p>
										...
										<label
											class="check <?= $ar["DISABLED"] ? 'disabled': '' ?>"
