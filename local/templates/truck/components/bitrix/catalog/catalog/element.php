...
<div class='container'>
	...
	if ($elementId > 0)
	{
		...
		if (!empty($recommendedData))
		{
			...
			{
				global $similarProductsFilter;

				$similarProductsFilter = array_merge(
					[
						'SECTION_ID' => $GLOBALS['FIRST_SECTION_ID'],
						'INCLUDE_SUBSECTIONS' => 'Y',
					],
					SP\Component::getAvailableProductsFilter()
				);
						...
						<div class="related-products">
							<?$APPLICATION->IncludeComponent(
					            ...
					            [
					                ...
					                'TEMPLATE_THEME'             => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
					                'FILTER_NAME'                => 'similarProductsFilter',
					                ...
					                'SLIDER_CONTAINER'           => 'related-products',
					                'SLIDER_VARIANT'             => 2,
