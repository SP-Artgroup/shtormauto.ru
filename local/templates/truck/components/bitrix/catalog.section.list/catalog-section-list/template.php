            ...
            case 'TILE':
                foreach ($arResult['SECTIONS'] as &$arSection)
                {
                    ...
                    <div
                        ...
                        style="background: url(<?= $arSection['PICTURE']['SRC'] ?>) no-repeat center; background-size: cover;"
                    >

                        <?php if ($arParams['HIDE_SECTION_NAME'] !== 'Y'): ?>
                            <h2><?= $arSection['NAME'] ?></h2>
                        <?php endif ?>

                        <div class="btn1">
                            <a href="<?= $arSection['SECTION_PAGE_URL'] ?>">Смотреть</a>
                        </div>
...
<? if($arParams['HIDE_CATALOG_TEXT'] != "Y"):?>
    <div class="catalog-text">
        <p>
            <? $APPLICATION->IncludeComponent(
                ...
                [
                    "AREA_FILE_SHOW" => "file",
                    "PATH"           => SITE_DIR . "include/catalog_section_list_desc.php",
                ],
                null,
                ['HIDE_ICONS' => 'Y']
            ) ?>
