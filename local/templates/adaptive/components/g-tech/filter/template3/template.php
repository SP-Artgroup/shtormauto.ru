...
usort($arResult["FILTER_VALUES"]["PROPERTY_PCD"]["VALUES"], 'subarray_sort');
usort($arResult["FILTER_VALUES"]["PROPERTY_OTVERSTIYA"]["VALUES"], 'subarray_sort');
usort($arResult["FILTER_VALUES"]["PROPERTY_DIAMETR"]["VALUES"], 'subarray_sort');
usort($arResult["FILTER_VALUES"]["PROPERTY_VYLET_LEGKOVOGO_DISKA_ET"]["VALUES"], 'subarray_sort');

//dump($arResult["FILTER_VALUES"]);
?>

<div class="grey-block filter toggle-box clear">
	...
	<div class="grey-block-content smart-filter content">
        <form action="<?=$arParams["RESULT_PAGE"]?>" method="get" class="smartfilter">
        	<input type="hidden" name="SIDEBAR_FILTER" value="1" />
        		<ul>
