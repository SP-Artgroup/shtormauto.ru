...
$this->addExternalCss($templateFolder .'/slider/style.css');
$this->addExternalJs($templateFolder . '/slider/script.js');
...
<div class="product-slider-wrapper hidden-xs">
	<div class="catalog-top product-slider" data-entity="<?=$containerName?>">
		<?
