	...
	<div class="form_register">
		...
		<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform">
			...
			<?if ($arResult["USE_CAPTCHA"] == "Y") { // CAPTCHA ?>
				<div class="item sm">
					<span class=""><b><?=GetMessage("CAPTCHA_REGF_TITLE")?></b></span>
				</siv>
				<div class="item">					
					<span>
			...
			<div class="item">
				<div class="checkboxes">
					<div class="check">
						<input type="checkbox" id="polit" ><label for="polit">Я принимаю условия <a href="/">политики конфиденциальности</a></label>
					</div>
				</div>
			</div>
			<?/*
