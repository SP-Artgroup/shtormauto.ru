...
<div class="section">
	...
	if (0 && is_array($arResult["ORDER_PROP"]["USER_PROFILES"]) && !empty($arResult["ORDER_PROP"]["USER_PROFILES"])):
...
<div class="bx_section">
	...
	<div class="block_item_item">
		<strong style="text-transform:uppercase;">Информация для оплаты и доставки заказа</strong>
		<strong>
