				...
				<div>
					...
					foreach ($arSource as $arProperties)
					{
						...
						if($arProperties['CODE'] == 'OTHER_CITY')
							continue;
						?>
						<div data-property-id-row="<?=intval(intval($arProperties["ID"]))?>"  class="order_prop_item">
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<div class="bx_block r3x1">
								<input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" class="<?=($arProperties['CODE'] == 'PHONE' ? 'phone' : '')?>" />
