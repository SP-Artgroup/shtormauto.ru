...
$elementSortField  = 'propertysort_SEZONNOST';
$elementSortOrder  = 'asc,nulls';
$elementSortField2 = "CATALOG_PRICE_" . $priceId;
$elementSortOrder2 = 'asc,nulls';
?>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPATIBLE_MODE" => "N",
		"COMPONENT_TEMPLATE" => "new2-catalog-redesign",
		"CONVERT_CURRENCY" => "N",
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			2 => "PROFIL",
			3 => "DIAMETR",
			4 => "VYLET_LEGKOVOGO_DISKA_ET",
			5 => "EMKOST_LITRY",
			6 => "SS",
			7 => "TIP_DISKA",
			8 => "SHIRINA_LEGKOVOGO_DISKA",
			9 => "TIP",
			10 => "SHIRINA_GRUZOVOGO_DISKA",
			11 => "VYLET_GRUZOVOGO_DISKA",
			12 => "PCD",
			13 => "DIAMETR_GRUZOVOY_SHINY_DISKA",
			14 => "OTVERSTIYA",
			15 => "SHIPOVKA",
			16 => "SHIRINA_GRUZOVOY_SHINY",
			17 => "TSENTRALNOE_OTVERSTIE_CB",
			18 => "PCD_1",
			19 => "MODEL",
			20 => "PROIZVODITEL",
			21 => "VYSOTA_ATVSHINY",
